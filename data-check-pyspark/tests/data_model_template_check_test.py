...
def test_uniqueness(spark: SparkSession):
    ...
    """).createOrReplaceTempView("order_details")
    ...
    assert_df_equals(spark.sql(sql_rendered), expected)
...
def test_denormalization(spark: SparkSession):
    ...
    """).createOrReplaceTempView("promotion_details")
...
def test_accuracy(spark: SparkSession):
    ...
    """).createOrReplaceTempView("real_result")
    ...
    spark.sql("""
        ...
        as (order_date, category_id, order_month, order_counts, sales_total, sales_avg, comment)
        """).createOrReplaceTempView("expected_result")
